...
public class CreateOffersGUI extends JFrame  {
private static final long serialVersionUID = 1L;
  ...
  public CreateOffersGUI(Vector<RuralHouse> v)
  {
    try
    {
      jbInit(v);
    ...
    this.jCalendar1.addPropertyChangeListener(new PropertyChangeListener()
    {
      public void propertyChange(PropertyChangeEvent propertychangeevent)
      {
        if (propertychangeevent.getPropertyName().equals("locale"))
        {
          ...
          jTextField1.setText(dateformat.format(startCalendar.getTime()));
        }
        else if (propertychangeevent.getPropertyName().equals("calendar"))
        {
          startCalendar = (Calendar) propertychangeevent.getNewValue();
          DateFormat dateformat1 = DateFormat.getDateInstance(1, jCalendar1.getLocale());
          jTextField1.setText(dateformat1.format(startCalendar.getTime()));
          jCalendar1.setCalendar(startCalendar);
        }
      } 
    });
    ...
    this.jCalendar2.addPropertyChangeListener(new PropertyChangeListener()
    {
      public void propertyChange(PropertyChangeEvent propertychangeevent)
      {
        if (propertychangeevent.getPropertyName().equals("locale"))
        {
          ...
          jTextField2.setText(dateformat.format(endCalendar.getTime()));
        }
        else if (propertychangeevent.getPropertyName().equals("calendar"))
        {
          endCalendar = (Calendar) propertychangeevent.getNewValue();
          DateFormat dateformat1 = DateFormat.getDateInstance(1, jCalendar2.getLocale());
          jTextField2.setText(dateformat1.format(endCalendar.getTime()));
          jCalendar2.setCalendar(endCalendar);
        }
      } 
    });
  ...
  private void jButton1_actionPerformed(ActionEvent e)
  {
	  	...
	  	try {
	  		...
	  		if (o==null)
	  			jLabel5.setText("Incorrect dates or overlapping offer");
